...
//    public static final int TYPE_NORMAL = 0;
    ...
    public String other_image_key1;
    public String other_image_key2;
    public String other_image_key3;
    public String other_image_key4;
    public String other_image_key5;
    public String other_image_key6;
    public String other_image_key7;
    public String other_image_key8;
    
    public String main_image_vps_name;
    public String swatch_image_vps_name;
    public String other_image_vps_name1;
    public String other_image_vps_name2;
    public String other_image_vps_name3;
    public String other_image_vps_name4;
    public String other_image_vps_name5;
    public String other_image_vps_name6;
    public String other_image_vps_name7;
    public String other_image_vps_name8;
...
//        }
    ...
    public ProductAmz createChild(int index, PriceFull priceFull, float promotionRate, float shippingPrice, AliexStoreInfo aliexStoreInfo) {

        ProductAmz child = new ProductAmz();
        StringBuilder sb = new StringBuilder();
        sb.append(item_sku).append("_").append(index);
        child.setItem_sku(sb.toString());       
        
//        productAmz.copyProduct(this);
        child.setParent_child("Child");
        child.setParent_sku(item_sku);
...
//        }
        ...
        for (PropertyFull propertyFull : priceFull.properties) {
            ...
            if (propertyFull.isColor()) {
                child.setColor_map(aliexStoreInfo.colorMap);
                ...
                child.setSize_map(aliexStoreInfo.sizeMap);
        ...
        if (isHasColor) {
            child.setColor_name(sbColor.toString());
        }

        if (isHasSize) {
            child.setSize_name(sbSize.toString());
        }

        if (isHasColor && isHasSize) {
            child.setVariation_theme(aliexStoreInfo.variationThemeBoth);
            child.setItem_name(item_name + " (" + child.getColor_name() + ", " + child.getSize_name() + ")");
        } else if (isHasColor && !isHasSize) {
            child.setVariation_theme(aliexStoreInfo.variationThemeColor);
            child.setItem_name(item_name + " (" + child.getColor_name() + ")");
        } else if (!isHasColor && isHasSize) {
            child.setVariation_theme(aliexStoreInfo.variationThemeSize);
            child.setItem_name(item_name + " (" + child.getSize_name() + ")");
        } else {
            return null;
        }
        ...
        if (aliexStoreInfo.isOnlyUS) {
            ...
            productPrice = (variationPrice * (1 - promotionRate) + shippingPrice) * priceRate;
        }
        ...
        child.setStandard_price("" + Utils.getCEOPrice(productPrice));

        child.setRelationship_type("variation");
        ...
        if (priceFull.getSkuImage() != null) {
            ...
            child.setMain_image_url(getMain_image_url());
        }
